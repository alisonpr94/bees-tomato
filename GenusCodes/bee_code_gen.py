...
def save_model(model, name_arq):
	filename = '/home/alison/Documentos/TomatoBeesRepository/models_genus/' + name_arq
...
def read_dataset(buzz):
	data = pd.read_csv('/home/alison/Documentos/TomatoBeesRepository/DatasetMFCC/dataset_genus_mfcc.csv', sep=',')
